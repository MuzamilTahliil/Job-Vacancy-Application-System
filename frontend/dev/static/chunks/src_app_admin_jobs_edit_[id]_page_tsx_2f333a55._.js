...
"[project]/src/app/admin/jobs/edit/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditJobPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditJobPage.useEffect": ()=>{
            // TODO: Replace with actual API call
            const fetchJob = {
                "EditJobPage.useEffect.fetchJob": async ()=>{
                    try {
                        setFetching(true);
                        const foundJob = mockJobs.find({
                            "EditJobPage.useEffect.fetchJob.foundJob": (j)=>j.id === jobId
                        }["EditJobPage.useEffect.fetchJob.foundJob"]);
                        if (foundJob) {
                            setJob(foundJob);
                            form.setFieldsValue({
                                ...
                                deadline: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(foundJob.deadline),
                                employerId: foundJob.employerId,
                                isActive: foundJob.isActive ? "active" : "inactive"
                            });
                        } else {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Job not found");
                            router.push("/admin/jobs");
                        }
                    } catch (error) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Failed to load job");
                        router.push("/admin/jobs");
                    } finally{
                        setFetching(false);
                    }
                }
            }["EditJobPage.useEffect.fetchJob"];
            if (jobId) {
                fetchJob();
            }
        }
    ...
    const handleFormSubmit = async (values)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("Job updated successfully!");
            router.push("/admin/jobs");
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Failed to update job");
            console.error(error);
        } finally{
            setLoading(false);
        }
    ...
    if (fetching) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$spin$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Spin$3e$__["Spin"], {
                ...
                fileName: "[project]/src/app/admin/jobs/edit/[id]/page.tsx",
                lineNumber: 146,
                columnNumber: 9
            }, this)
        }, void 0, false, {
...
_s(EditJobPage, "/qQP1dVGrBPyMTQQxIOp8EFRzgQ=", false, function() {
    return [
...
_c = EditJobPage;
var _c;
__turbopack_context__.k.register(_c, "EditJobPage");
...
//# sourceMappingURL=src_app_admin_jobs_edit_%5Bid%5D_page_tsx_2f333a55._.js.map